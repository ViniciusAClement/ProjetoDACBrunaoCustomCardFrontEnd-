...
function Header({ onRegisterClick, onLoginClick, onStockClick, onLogoutClick, user, onLogoClick, onSearch }) {
        ...
        <div className="user-section">
          {user ? (
            <>
              ...
              {user.isAdmin && (
                <button className="header-link" onClick={onStockClick}>Estoque</button>
              )}
              <button className="header-link" onClick={onLogoutClick}>Sair</button>
            </>
          ) : (
            <>
